...
create table if not exists public.quote_plants (
 ...
 package text, category text, purchase_net numeric(14,2), sale_net numeric(14,2), sale_price_placeholder boolean not null default false, active boolean not null default true,
